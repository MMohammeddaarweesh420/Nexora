            ...
            {submitted ? (
              <div className="text-center py-12 animate-in zoom-in duration-300">
                ...
                <h3 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">
                  {language === 'ar' ? 'تم إرسال الطلب!' : 'Inquiry Sent!'}
                </h3>
                <p className="text-slate-600 dark:text-gray-400">
                  {language === 'ar' ? 'سنرد عليك في غضون 24 ساعة عمل.' : "We'll get back to you within 24 business hours."}
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" className="w-full" size="lg">
                  {language === 'ar' ? 'إرسال الطلب' : 'Send Inquiry'}
                </Button>
              </form>
            )}
          </div>
          ...
          <div className="space-y-12 rtl:text-right">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 rtl:space-x-reverse">
                  ...
                  <span className="text-slate-700 dark:text-gray-300">info@nexora.com</span>
                </div>
                <div className="flex items-center space-x-4 rtl:space-x-reverse">
            ...
            <div className="p-8 bg-gradient-to-br from-emerald-500/10 to-sky-500/10 border border-slate-200 dark:border-white/10 rounded-3xl">
              <h4 className="font-bold mb-4 text-slate-900 dark:text-white">
                {language === 'ar' ? 'هل تحتاج إلى رد فوري؟' : 'Need an immediate reply?'}
              </h4>
              <p className="text-slate-600 dark:text-gray-400 text-sm mb-6">
                {language === 'ar' ? 'تحدث مع مستشارينا الآن عبر واتساب للحصول على استجابة سريعة.' : 'Chat with our consultants right now on WhatsApp for a quick response.'}
              </p>
              <Button variant="outline" className="w-full bg-white dark:bg-transparent">
                ...
                {language === 'ar' ? 'دردش الآن' : 'Chat Now'}
              </Button>
            </div>
          </div>
        </div>
